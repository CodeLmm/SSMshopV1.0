		...
		<div class="row">
			...
			<script type="text/javascript">
				...
				function addProduct(){
					...
					//如果登录了，flag==true
					if(flag){
						//用JavaScript发请求到CartServlet
						var url = "${pageContext.request.contextPath}/cart?method=addProduct&pid="+pid+"&num="+num;
						window.location.href = url;
					//如果没登录了，flag==false
					}else{
						//弹出一个确认框
						var flag = window.confirm("亲，你还没有登录，去登录一下吧。");
						//如果用户按了确认按钮
						if(flag){
							//用JavaScript发请求到login.jsp页面
