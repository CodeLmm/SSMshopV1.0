			...
			<c:when test="${!empty PAGE_BEAN.list}">
				<c:forEach var="product" items="${PAGE_BEAN.list}">
					<div class="col-md-2">
						...
						<p>
							<a href="${pageContext.request.contextPath}/product?method=findProductByPid&pid=${product.pid}" style='color: green'>
								${product.pname}
							</a>
						</p>
						<p>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:choose>
				...
				<c:otherwise>
					<li>
						<a href="${pageContext.request.contextPath}/product?method=findAllProductByCid&cid=${param.cid}&currPageNO=${PAGE_BEAN.currPageNO-1}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
				</c:otherwise>
			...
			<c:choose>
				...
				<c:otherwise>
					<li>
						<a href="${pageContext.request.contextPath}/product?method=findAllProductByCid&cid=${param.cid}&currPageNO=${PAGE_BEAN.currPageNO+1}" aria-label="Next"> 
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:otherwise>
